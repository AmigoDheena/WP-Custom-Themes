    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up"><?php echo $banner['heading']; ?></h1>
          <h2 data-aos="fade-up" data-aos-delay="400"><?php echo $banner['sub_heading']; ?></h2>
          <div data-aos="fade-up" data-aos-delay="600">
            <div class="text-center text-lg-start">
              <a href="<?php echo $banner['button_link']; ?>" class="btn-get-started scrollto d-inline-flex align-items-center justify-content-center align-self-center">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 mt-4 mt-lg-0">
            <div class="box" data-aos="fade-up" data-aos-delay="400">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/img/values-2.png" class="img-fluid" alt="">
          ...
          <div class="col-lg-4 mt-4 mt-lg-0">
            <div class="box" data-aos="fade-up" data-aos-delay="600">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/img/values-3.png" class="img-fluid" alt="">
    ...
    <section id="features" class="features">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/features.png" class="img-fluid" alt="">
          </div>
        ...
        <div class="row feture-tabs" data-aos="fade-up">
          ...
          <div class="col-lg-6">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/features-2.png" class="img-fluid" alt="">
          </div>
        ...
        <div class="row feature-icons" data-aos="fade-up">
          ...
          <div class="row">
            ...
            <div class="col-xl-4 text-center" data-aos="fade-right" data-aos-delay="100">
              <img src="<?php echo get_template_directory_uri(); ?>/assets/img/features-3.png" class="img-fluid p-4" alt="">
            </div>
        ...
        <div class="row gy-4" data-aos="fade-left">
          ...
          <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="100">
            <div class="box">
              ...
              <img src="<?php echo get_template_directory_uri(); ?>/assets/img/pricing-free.png" class="img-fluid" alt="">
              <ul>
                <li>Aida dere</li>
          ...
          <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="box">
              ...
              <img src="<?php echo get_template_directory_uri(); ?>/assets/img/pricing-starter.png" class="img-fluid" alt="">
              <ul>
                <li>Aida dere</li>
                <li>Nec feugiat nisl</li>
                <li>Nulla at volutpat dola</li>
          ...
          <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="300">
            <div class="box">
              ...
              <img src="<?php echo get_template_directory_uri(); ?>/assets/img/pricing-business.png" class="img-fluid" alt="">
              <ul>
                <li>Aida dere</li>
                <li>Nec feugiat nisl</li>
                <li>Nulla at volutpat dola</li>
          ...
          <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="400">
            <div class="box">
              ...
              <img src="<?php echo get_template_directory_uri(); ?>/assets/img/pricing-ultimate.png" class="img-fluid" alt="">
              <ul>
                <li>Aida dere</li>
                <li>Nec feugiat nisl</li>
                <li>Nulla at volutpat dola</li>
